try {
  (() => {
    ...
    function xt(e, t) {
      if (t === "transparent") return t;
      var r = R(t);
      return C(T({}, r, { lightness: P(0, 1, r.lightness - parseFloat(e)) }));
    }
    var bl = S(xt);
    function Pt(e, t) {
      if (t === "transparent") return t;
      var r = R(t);
      return C(T({}, r, { saturation: P(0, 1, r.saturation - parseFloat(e)) }));
    }
    var hl = S(Pt);
    function Dt(e, t) {
      if (t === "transparent") return t;
    ...
    function Ft(e, t) {
      ...
      var r = x(t),
        ...
        a = T({}, r, { alpha: P(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return Y(a);
    }
    var Ht = S(Ft),
      Xe = Ht;
    ...
    var Yt = "actions",
      ...
      X = {};
    qt(X, { chromeDark: () => ar, chromeLight: () => or });
    var ar = {
          ...
          i.forEach((l) => {
            let u = l.split("."),
              c = (p, d, f) => {
                ...
                let E = u[f];
                if (f === 0) J(p, t) && (E === K || E === Ke) && c(p, K, f + 1);
                else if (E === Ke)
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Cr = ({ isCloseTag: e, data: t, expanded: r }) => {
        ...
        switch (t.nodeType) {
          ...
          case Node.DOCUMENT_FRAGMENT_NODE:
            return o.createElement("span", null, t.nodeName);
          default:
            return o.createElement("span", null, Rr[t.nodeType]);
        }
      },
      Nr = function* (e) {
        if (e && e.childNodes) {
      ...
      lt = Ae(({ children: e, className: t }, r) =>
        o.createElement(
          Le,
