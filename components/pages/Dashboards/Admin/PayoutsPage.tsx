  ...
  return (
    <div className="min-h-screen bg-muted/50 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden shadow-sm">
          {loading ? (
            ...
            <div className="p-20 text-center space-y-4">
              <div className="bg-muted w-16 h-16 rounded-lg flex items-center justify-center mx-auto text-muted-foreground">
                <CheckCircle size={32} />
              </div>
              <p className="text-muted-foreground font-medium">
        ...
        {/* Security Note */}
        <div className="flex items-center gap-3 p-4 bg-muted/50 border border-border rounded-lg text-muted-foreground">
          <AlertCircle size={18} />
