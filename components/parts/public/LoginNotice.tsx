  ...
  return (
    <div className="fixed bottom-2 right-2 flex justify-center z-[100] pointer-events-none">
      <Link
        ...
        className="pointer-events-auto flex items-center gap-3 bg-foreground text-white px-4 py-2 rounded-lg shadow-2xl shadow-orange-500/20 hover:bg-orange-600 hover:-translate-y-1 transition-all duration-300 group"
      >
