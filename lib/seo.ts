...
const SITE_DESCRIPTION =
  "The premier platform for creators to monetize their content and grow their community through support from fans.";
...
export function generateCreatorMetadata(
  ...
  const description =
    bio ||
    `Support ${creatorName} on Agaseke. Fueling creativity one contribution at a time.`;
